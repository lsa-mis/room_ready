...
Devise.setup do |config|
  ...
  #   provider :saml,
  #     assertion_consumer_service_url: "https://spaceready-staging.lsa.umich.edu/",
  #     issuer:                         "https://spaceready-staging.lsa.umich.edu/",
  #     idp_sso_service_url:            Rails.application.credentials.dig(:okta, :idp_sso_service_url),
  #     idp_cert:                       Rails.application.credentials.dig(:okta, :idp_cert),
  #     idp_cert_fingerprint_validator: Rails.application.credentials.dig(:okta, :idp_cert_fingerprint),
  #     name_identifier_format:         "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"
  # end
  ...
  # config.pepper = 'f0b41bf78d17a20a87e69525b11a70095b4cebe97ca889f75489b3e8e187bb82a8d785944b985e1f2ddb8fc0174c170689494823c08b7ca100c731a86c399f39'
  ...
  # end
  # Configure Warden to use the CustomFailure app
  config.warden do |manager|
