  ...
  def create
    ...
    respond_to do |format|
      if @room_state.save
        ...
        format.html { redirect_to new_common_attribute_state_path(room_id: @room), notice: notice }
      else
  ...
  def update
    respond_to do |format|
      if @room_state.update(room_state_params)
        ...
        format.html { redirect_to new_common_attribute_state_path(room_id: @room), notice: "Room state was successfully updated." }
      else
