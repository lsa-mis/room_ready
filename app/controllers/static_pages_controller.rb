class StaticPagesController < ApplicationController
  ...
  def dashboard
    ...
    if params[:dashboard_date].present?
      @selected_date = Date.parse(params[:dashboard_date])
      render turbo_stream: turbo_stream.update("zones_overview", partial: "zones_overview")
    else
