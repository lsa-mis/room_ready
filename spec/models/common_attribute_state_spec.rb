...
RSpec.describe CommonAttributeState, type: :model do
  ...
  context "create common_attribute_state without checkbox_value when common_attribute.need_checkbox is false" do
    it 'is valid' do
      common_attribute_state = FactoryBot.create(:common_attribute_state, checkbox_value: nil, common_attribute: FactoryBot.create(:common_attribute, need_checkbox: false))
  ...
  context "create common_attribute_state with checkbox_value when common_attribute.need_checkbox is false" do
    it 'raises an error: Checkbox value must be blank if checkbox is not required' do
      common_attribute_state = FactoryBot.create(:common_attribute_state, checkbox_value: true, common_attribute: FactoryBot.create(:common_attribute, need_checkbox: false))
      expect(common_attribute_state.valid?).to be_falsy
  ...
  context "create common_attribute_state with quantity_box_value when common_attribute.need_quantity_box is false" do
    it 'raises an error: Quantity box value must be blank if quantity box is not required' do
      common_attribute_state = FactoryBot.create(:common_attribute_state, quantity_box_value: 1, common_attribute: FactoryBot.create(:common_attribute, need_quantity_box: false))
      expect(common_attribute_state.valid?).to be_falsy
  ...
  context "update common_attribute_state with checkbox_value when common_attribute.need_checkbox is true" do
    it 'is valid' do
  ...
  context "update common_attribute_state with quantity_box_value when common_attribute.need_quantity_box is true" do
    it 'is valid' do
      common_attribute_state = FactoryBot.create(:common_attribute_state, quantity_box_value: nil, common_attribute: FactoryBot.create(:common_attribute, need_quantity_box: true))
      common_attribute_state.update(quantity_box_value: 1)
      expect(common_attribute_state).to be_valid
